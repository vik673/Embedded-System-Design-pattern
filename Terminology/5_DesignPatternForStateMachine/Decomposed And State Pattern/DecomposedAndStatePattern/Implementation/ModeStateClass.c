...
void ModeStateClass_entryAction(ModeStateClass* const me) {
    printf("ModeStateClass: Entering default state STARTINGUP\n");
    me->currentState = me->defaultState;
}

int ModeStateClass_evAbort(ModeStateClass* const me) {
    printf("ModeStateClass: Processing evAbort event\n");
    return 1;
}

int ModeStateClass_evRun(ModeStateClass* const me) {
    printf("ModeStateClass: Processing evRun event\n");
...
int ModeStateClass_evShutDown(ModeStateClass* const me) {
    printf("ModeStateClass: Processing evShutDown event\n");
    switch (me->currentState) {
        case OPERATIONAL_STATE:
...
void ModeStateClass_exitAction(ModeStateClass* const me) {
    printf("ModeStateClass: Exiting state\n");
}
