...
void ErrorStateClass_entryAction(ErrorStateClass* const me) {
    printf("ErrorStateClass: Entering default state OK\n");
    me->currentState = me->defaultState;
}

int ErrorStateClass_evAbort(ErrorStateClass* const me) {
    printf("ErrorStateClass: Processing evAbort event\n");
...
int ErrorStateClass_evError(ErrorStateClass* const me) {
    printf("ErrorStateClass: Processing evError event\n");
    switch(me->currentState) {
        case OK_STATE:
...
int ErrorStateClass_evOk(ErrorStateClass* const me) {
    printf("ErrorStateClass: Processing evOk event\n");
    switch(me->currentState) {
        case WARNING_STATE:
...
int ErrorStateClass_evWarning(ErrorStateClass* const me) {
    printf("ErrorStateClass: Processing evWarning event\n");
    switch(me->currentState) {
        case OK_STATE:
...
void ErrorStateClass_exitAction(ErrorStateClass* const me) {
    printf("ErrorStateClass: Exiting state\n");
}
