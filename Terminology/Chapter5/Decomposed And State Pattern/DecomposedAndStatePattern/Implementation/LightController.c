...
void LightController_evEnable(LightController* const me) {
    ...
    printf("LightController: Processing evEnable event\n");
...
void LightController_evDisable(LightController* const me) {
    HighLevelLightStates newState;
    printf("LightController: Processing evDisable event\n");
...
void LightController_reset(LightController* const me) {
    HighLevelLightStates newState;
    printf("LightController: Processing reset event\n");
...
void LightController_evOk(LightController* const me) {
    ...
    ActionPtr0 aPtr;
    HighLevelLightStates newState;
    printf("LightController: Processing evOk event\n");
...
void LightController_evWarning(LightController* const me) {
    ...
    ActionPtr0 aPtr;
    HighLevelLightStates newState;
    printf("LightController: Processing evWarning event\n");
...
void LightController_evError(LightController* const me) {
    ...
    ActionPtr0 aPtr;
    HighLevelLightStates newState;
    printf("LightController: Processing evError event\n");
...
void LightController_evRun(LightController* const me) {
    ...
    ActionPtr0 aPtr;
    HighLevelLightStates newState;
    printf("LightController: Processing evRun event\n");
...
void LightController_evShutDown(LightController* const me) {
    ...
    ActionPtr0 aPtr;
    HighLevelLightStates newState;
    printf("LightController: Processing evShutDown event\n");
...
void LightController_evAbort(LightController* const me) {
    ...
    printf("LightController: Processing evAbort event\n");
    ...
    switch (me->currentState) {
        case ON_STATE:
            ...
            if (precond1 && precond2) {
                printf("LightController: Preconditions met - transitioning to EMERGENCY\n");
                ...
                printf("LightController: Preconditions not met for abort\n");
            };
            break;
...
void LightController_enter_OffState(LightController* const me, HighLevelLightStates newState) {
    printf("LightController: Entering OFF state\n");
